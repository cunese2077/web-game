...
let records = [];
let achievements = {};
let lastGame = { score: 0, level: 0, kills: 0, bossKills: 0, newAchievementIds: [] };
// ========== 派生统计计算 ==========
...
function recordGameEnd(score, level, kills, bossKills) {
    const record = {
        id: Date.now(),
...
// 初始化加载
loadData();
export { recordGameEnd, getStats, getLastGame, getAchievementDefs, isUnlocked, deleteAchievement, resetAllData, getRecords, deleteRecord, };
