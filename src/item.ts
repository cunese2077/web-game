...
class Item {
  ...
  _drawHeart(size: number, color: string): void {
    ctx.beginPath();
  ...
  _drawFlame(size: number, color: string): void {
    ctx.beginPath();
  ...
  _drawShield(size: number, color: string): void {
    ctx.beginPath();
    ctx.moveTo(0, -size * 0.5);
  ...
  _drawStar(size: number, color: string): void {
  ...
  static checkCollision(heroX: number, heroY: number, heroW: number, heroH: number): ItemType[] {
  ...
  static add(x: number, y: number, type: ItemType = "heal"): void {
